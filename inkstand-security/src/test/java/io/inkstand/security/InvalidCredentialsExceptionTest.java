...
public class InvalidCredentialsExceptionTest {
     ...
     */
    private InvalidCredentialsException subject_with_userId;
    private InvalidCredentialsException subject_with_userId_and_cause;

    @Before
    public void setUp() throws Exception {
        subject_with_userId = new InvalidCredentialsException("testUser");
        subject_with_userId_and_cause = new InvalidCredentialsException("testUser", cause);
    }

    @Test
    public void testGetMessage() throws Exception {
        assertEquals("Invalid credentials [user=testUser]", subject_with_userId.getMessage());
        assertEquals("Invalid credentials [user=testUser]", subject_with_userId_and_cause.getMessage());
    }
